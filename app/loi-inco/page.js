              ...
              <div key={i} style={{ display: "flex", gap: 20, paddingBottom: i < TIMELINE.length - 1 ? 28 : 0 }}>
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", width: 40, flexShrink: 0 }}>
                  <div style={{ width: 40, height: 40, borderRadius: "50%", background: "#1A1A1A", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <span style={{ fontSize: 10, fontWeight: 800, color: "white" }}>{item.year.slice(2)}</span>
                  </div>
                  {i < TIMELINE.length - 1 && <div style={{ width: 2, flex: 1, background: "#EBEBEB", marginTop: 6 }} />}
                </div>
                <div style={{ paddingTop: 8, paddingBottom: 8 }}>
                  <div style={{ fontSize: 11, fontWeight: 700, color: "#888", marginBottom: 2 }}>{item.year}</div>
